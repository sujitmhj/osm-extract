...
schools_polygon.pbf: event-latest.pbf
...
medical_point.pbf: event-latest.pbf
...
all_roads.pbf: event-latest.pbf
...
police_stations.pbf: event-latest.pbf
...
restaurants.pbf: event-latest.pbf
